	...
	<div class="container6">
		...
		<div id="main">
           ...
           <<form action="updateemployee" method="post">
						...
						<table class="c" border="1px solid black">
							...
							<c:if test="${empl.empId ne emp.empId}">
								<tr>
									...
									<td><a
										href="editemployee?empId=${emp.empId}&deptId=${emp.deptEmpId}"><img src="/images/edit.png"/></a></td>
									<td><a
										href="deleteemployee?empId=${emp.empId}&deptEmpId=${emp.deptEmpId}"><img src="/images/delete.jpg"/></a></td>
								</tr>
							</c:if>
						</c:forEach>
			...
			</div>	<%-- <c:if test="${mainemps eq 'checktableedit' }">
